...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified',])->group(function () {
    Route::group(['middleware' => ['user']], function () {
        Route::controller(LeadsController::class)->group(function () {
            Route::get("/apps/leads", "leads_index_page")->name('dashboards.leads.index'); 
            Route::get("/apps/leads/create", "create_lead_page")->name('dashboards.leads.create'); 
            Route::post("/apps/leads/create", "store")->name('dashboards.leads.store'); 
            Route::get("/apps/leads/get/{pipeline_id?}", "get")->name('dashboards.leads.get'); 
            Route::put('/app/leads/edit/{id?}', 'update')->name('dashboards.leads.update');
        });
