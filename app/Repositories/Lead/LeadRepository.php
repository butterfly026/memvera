...
class LeadRepository extends Repository
{
     ...
     *
     * @var \App\Repositories\Lead\ProductRepository
     */
     ...
     * @param  App\Repositories\Lead\ProductRepository  $productRepository
    ...
    public function getLeads($pipelineId, $term, $createdAtRange)
    {
        return $this
                ...
                //             $query->whereIn('leads.user_id', app('\App\Repositories\User\UserRepository')->getCurrentUserGroupsUserIds());
                //         } else {
