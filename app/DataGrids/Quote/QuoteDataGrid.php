...
class QuoteDataGrid extends DataGrid
{
    ...
    public function addColumns()
    {
        ...
        $this->addColumn([
            'index'    => 'person_name',
            'label'    => trans('app.datagrid.person'),
            'type'     => 'string',
            'sortable' => true,
            'closure'  => function ($row) {
        ...
        $this->addColumn([
            'index'    => 'sub_total',
            'label'    => trans('app.datagrid.sub-total'),
            'type'     => 'string',
            'sortable' => true,
            'closure'  => function ($row) {
        ...
        $this->addColumn([
            ...
            'label'    => trans('app.datagrid.discount'),
            'type'     => 'string',
            'sortable' => true,
            'closure'  => function ($row) {
        ...
        $this->addColumn([
            ...
            'label'    => trans('app.datagrid.adjustment'),
            'type'     => 'string',
            'sortable' => true,
            'closure'  => function ($row) {
        ...
        $this->addColumn([
            'index'    => 'grand_total',
            'label'    => trans('app.datagrid.grand-total'),
            'type'     => 'string',
            'sortable' => true,
            'closure'  => function ($row) {
        ...
        $this->addColumn([
            'index'      => 'expired_at',
            'label'      => trans('app.leads.expired-at'),
            'type'       => 'date_range',
            'searchable' => false,
            'sortable'   => true,
            'closure'    => function ($row) {
