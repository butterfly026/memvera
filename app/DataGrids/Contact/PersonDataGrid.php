...
class PersonDataGrid extends DataGrid
{
    ...
    public function addColumns()
    {
        ...
        $this->addColumn([
            'index'    => 'emails',
            'label'    => trans('app.datagrid.emails'),
            'type'     => 'string',
            'sortable' => false,
        ...
        $this->addColumn([
            ...
            'label'    => trans('app.datagrid.contact_numbers'),
            'type'     => 'string',
            'sortable' => false,
            'closure'  => function ($row) {
        ...
        $this->addColumn([
            'index'            => 'organization',
            'label'            => trans('app.datagrid.organization_name'),
            'type'             => 'dropdown',
    ...
    public function prepareActions()
    {
        ...
        $this->addAction([
            ...
            'confirm_text' => trans('ui::app.datagrid.massaction.delete', ['resource' => trans('app.contacts.persons.person')]),
            'icon'         => 'trash-icon',
        ]);
    }
